export const dictionaries = {
  en: {
    nav: { home: 'Home', books: 'My Books', community: 'Community', buy: 'Get Your Copy', signIn: 'Sign In', join: 'Join', profile: 'Profile', settings: 'Settings', signOut: 'Sign Out' },
    settings: {
  ...
  ar: {
    nav: { home: 'الرئيسية', books: 'كتبي', community: 'المجتمع', buy: 'احصل على نسختك', signIn: 'تسجيل الدخول', join: 'إنشاء حساب', profile: 'الملف الشخصي', settings: 'الإعدادات', signOut: 'تسجيل الخروج' },
    settings: {
